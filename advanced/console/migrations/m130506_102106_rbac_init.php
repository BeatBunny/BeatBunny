 ...
 * @since 2.0
 */
class m130506_102106_rbac_init extends \yii\db\Migration
{
    /**
    ...
    public function up()
    {
        ...
        $tableRules = $this->db->tablePrefix . 'auth_rule';
        if ($this->db->getTableSchema($tableRules, true) === null) {
        ...
        $tableItem = $this->db->tablePrefix . 'auth_item';
        if ($this->db->getTableSchema($tableItem, true) === null) {
        ...
        $tableItemChild = $this->db->tablePrefix . 'auth_item_child';
        if ($this->db->getTableSchema($tableItemChild, true) === null) {
        ...
        $tableAssignment = $this->db->tablePrefix . 'auth_assignment';
        if ($this->db->getTableSchema($tableAssignment, true) === null) {
        ...
        if (($this->db->getTableSchema($tableItemChild, true))&&($this->db->getTableSchema($tableItem, true))&&($this->db->getTableSchema($tableAssignment, true))) {
            if ($this->isMSSQL()) {
